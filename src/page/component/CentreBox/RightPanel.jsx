...
const Trifacta = (index)=>{
  {setDot(true); setCurrentIndex(index);setIsHovered(false)
}
}

  return (
    <div className="w-[60%] h-fit relative  py-4"
    onMouseEnter={() => {setIsHovered(true),RemoveTimeOut()}}  // Set hovered state to true on mouse enter
   ...
   {/* Image Description */}
<p className="px-8 text-sm font-open text-[#6c6c6c] text-left line-clamp-2 hover:line-clamp-none transition-all duration-300 ease-in-out
